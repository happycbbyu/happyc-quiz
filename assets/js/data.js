...
const QUESTIONS = [
  // ── 순자산·재무 ──────────────────────────────
  {
    ...
    opts: [
      ...
      { text: '5,000만원 ~ 1억원이에요', score: 2 },
      { text: '1억원 ~ 3억원이에요', score: 3 },
  ...
  },
  {
    ...
    opts: [
      { text: '1억원 이상이에요', score: 0 },
      { text: '5,000만원 ~ 1억원이에요', score: 1 },
      { text: '1,000만원 ~ 5,000만원이에요', score: 2 },
  ...
  },
  {
    ...
    opts: [
      { text: '10% 미만 저축해요', score: 0 },
      { text: '10~20% 저축해요', score: 1 },
  ...
  },
  {
    ...
    opts: [
      ...
      { text: '300만원 ~ 800만원이에요', score: 2 },
      { text: '800만원 ~ 1,000만원이에요', score: 3 },
  ...
  },
  {
    ...
    opts: [
      { text: '투자가 무서워서 시작조차 못했어요', score: 0 },
      { text: '남의 말만 믿고 기준 없이 투자했어요', score: 1 },
      { text: '떨어질 때 무서워서 손절하고 나왔어요', score: 2 },
      { text: '단기간에 크게 벌고 싶어서 무리하게 투자했어요', score: 3 },
      { text: '수익이 나도 기준 없이 사고팔기를 반복했어요', score: 4 },
    ],
  },
...
const LEVELS = [
  {
    ...
    actions: [
      ...
      { title: '부부 돈 대화 5원칙 세우기', desc: '매일 1회 돈·관계 대화를 시작해요. "사랑의 언어 테스트"로 다정한 대화법을 찾아요.' },
  ...
  },
  {
    ...
    emoji: '🌿',
    title: 'LEVEL 2 · 종잣돈',
    range: '순자산 0원 ~ 5,000만원',
    oneliner: '시스템이 습관을 만들어요',
    quote: '"따로 관리하는 돈보다, 함께 보는 돈이 부부를 더 단단하게 만들어요. 시스템이 습관을 만들어요."',
    color: '#E89B4F',
    trap: '"남으면 저축" — 영원히 저축이 없어요. 라이프스타일 인플레이션이 최대 적이에요.',
    actions: [
      { title: '경제공부 루틴 만들기', desc: '경제신문 매일 읽기 + EBS 자본주의 다큐는 필수예요. 읽은 걸 내 언어로 말해보는 게 핵심이에요.' },
      { title: '통장결혼식', desc: '자산합치기 → 통장쪼개기 → 부부총회 3단계를 완성해요. 돈의 흐름을 한눈에 보이게 구조화해요.' },
      { title: '투자의 첫걸음, 예적금 탈출', desc: '비상금·목적통장은 CMA·파킹통장으로 옮겨요. 여유자금은 RP·발행어음·채권을 활용해요.' },
    ],
  ...
  },
  {
    ...
    emoji: '🚀',
    title: 'LEVEL 3 · 투자 입문',
    range: '순자산 5,000만원 ~ 1억원',
    oneliner: '돈이 일하기 시작해요',
    quote: '"시장을 이기려 하지 말고, 시장에 올라타요. 우리 부부만의 투자 기준을 만드는 단계예요."',
    color: '#4FA8E8',
    trap: '5,000만원이 모이면 개별종목에 몰빵하기 쉬운 구간이에요. 몇 년 모은 돈을 몇 달 만에 잃기도 해요.',
    actions: [
      { title: '경제사이클 이해 후 ETF 시작', desc: '시장이해 → ETF → 미국주식 → 국내주식 순서로 시작해요. ISA·연금저축·IRP 계좌를 함께 활용해요.' },
      { title: '생애주기별 계좌 전략', desc: '내집마련을 3년 이후에 한다면 ISA 위주로, 3년 이내에 계획이 있다면 달러ETF·채권으로 돈을 지켜요.' },
  ...
  },
  {
    ...
    actions: [
      { title: '주거 전략 결정', desc: '전세·월세·매매의 기회비용을 함께 비교해봐야 해요.중요한 건 우리 부부의 현금흐름, 투자성향에 맞는 선택이에요.' },
  ...
  },
  {
    ...
    title: 'LEVEL 5 · 자산 확장',
    range: '순자산 3억원 이상',
    oneliner: '자산·투자·소득을 함께 키워가는 시기예요.',
    quote: '"소비자가 아닌 생산자가 되는 단계예요. 근로소득만으로 한계를 느끼기 시작하는 시기예요. 적극적으로 소득을 늘려야 해요."',
    color: '#4FBE8A',
    trap: '자산이 늘어나는 속도가 갑자기 느려진 느낌이 들어요. 무리한 투자보다 튼튼한 자산 성장 구조를 만드는 게 중요해요.',
    actions: [
      { title: '갈아타기 전략', desc: '현재 집 대비 1.2~1.5배 상급지를 목표로 해요. 최소 2년 거주 후 양도세를 절감해요.' },
      { title: '투자 지속 + 성장주 비중', desc: '신혼부부 최대 자산은 시간이에요. 장기 성장 자산에 꾸준히 투자하며 복리를 이어가요.' },
      { title: '부업 → 사업으로', desc: '스레드 → 블로그 → 인스타 → 유튜브 순서로 시작해요. 나로부터 시작하는 게 핵심이에요.' },
    ],
